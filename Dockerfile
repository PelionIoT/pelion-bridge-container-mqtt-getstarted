...
RUN apt-get -y install openjdk-8-jre vim locales openssh-server supervisor dnsutils unzip zip ntp mosquitto npm sudo git
RUN apt-get -y update
RUN apt-get -y install curl dirmngr apt-transport-https lsb-release ca-certificates curl
RUN apt-get -y update
